...
function draw_text_tags_original() {
	/*
	*
	...
	*/
	...
	if (align==1 && mode==0)
	{
	    ...
	    lines = draw_text_tags(x1, y1, text, boxW, -1, maxHeight, align, textArray); // Mode 1
	}
		...
		else if (c == "[")
		{
			...
			else
			{
	            ...
	            if (c == "]")
				{
					...
					{
	                    if (mode == 0)
						{ //Don't swap colors when measuring
	                        // Convert...
